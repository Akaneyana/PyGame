...
from frontend.login.loginPage import login_page  # Import the login page function
...
login_page_button_position = (250, 400)
...
while running:
    ...
    reaction_time_button_rect = pygame.Rect(reaction_time_button_position, button_size)
